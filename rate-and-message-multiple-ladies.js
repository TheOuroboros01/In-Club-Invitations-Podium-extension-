...
'Val56',
'Ulyana',
'Ели', //removed most presidents till 7900 fame or page 14 of club ranks page or top 280 clubs in the game
  ].map(n => n.toLowerCase()));
  ...
  const excludedClubNames = new Set([
    ...
    'Rule Breakers','Ƹ̴Ӂ̴ƷBuTtErFly','♔ Pearls 𝕀𝕀 ♔','New Era','Lunar Queens','UNIVERSE TEAM','♛✰ VR-46 ✰♛','Dazzling Divas 💎','baddie girls',
    'VENUS®',
'Valkyries',
'JJF',
'Models Inc💎',
